...
class Vertex:
    ...
    def connect(self):
        self.right = self.maze.array[self.position[0]][self.position[1] + 1] if self.position[1] < len(
            self.maze.array) - 1 else None
        ...
        self.down = self.maze.array[self.position[0] + 1][self.position[1]] if self.position[0] < len(
            self.maze.array) - 1 else None
        return
